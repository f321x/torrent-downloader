This is the repository of a simple python bittorrent client using the libtorrent library for the torrent protocol and tkinter as gui framework.
...
After being done with changes always run the unittests with "python -m unittest discover -v tests" and verify they pass. 
Never add any external dependency, neither for application code nor for tests, the only external dependency we use is the libtorrent library.
